...
**Bundled**
```
wget https://github.com/tkellen/kwm/releases/download/v0.6.1/kwm
chmod +x kwm
...
```
mkdir kwm && cd kwm
wget https://github.com/tkellen/kwm/releases/download/v0.6.1/kwm-unbundled-v0.6.1.tar.gz
tar xzf kwm-unbundled-v0.6.1.tar.gz
export PATH=$PATH:$PWD
kwm
```
