...
**Bundled**
```
wget https://github.com/tkellen/kwm/releases/download/v0.7.0/kwm
chmod +x kwm
...
```
mkdir kwm && cd kwm
wget https://github.com/tkellen/kwm/releases/download/v0.7.0/kwm-unbundled-v0.7.0.tar.gz
tar xzf kwm-unbundled-v0.7.0.tar.gz
export PATH=$PATH:$PWD
kwm
```
